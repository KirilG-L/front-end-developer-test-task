...
const CartButton: React.FC<PropsType> = (props) => {
    ...
    <Container>
      <StyledButtonContainer onClick={handleClick}>
        ...
        >
          ...
          />
          <path
            d="M7.03123 20.4375C7.03123 21.6006 7.97752 22.5469 9.14061 22.5469C10.3037 22.5469 11.25 21.6006 11.25 20.4375C11.25 19.2744 10.3037 18.3281 9.14061 18.3281C7.97752 18.3281 7.03123 19.2744 7.03123 20.4375ZM9.14061 19.7344C9.52824 19.7344 9.84373 20.0499 9.84373 20.4375C9.84373 20.8251 9.52824 21.1406 9.14061 21.1406C8.75298 21.1406 8.43748 20.8251 8.43748 20.4375C8.43748 20.0499 8.75298 19.7344 9.14061 19.7344Z"
            fill="white"
          />
          <path
        ...
        <StyledButtonText>До кошика</StyledButtonText>
